...
public class RecordSetTest {
    ...
    public void sendsUpdateMessageForEntireRecord() throws DeepstreamRecordDestroyedException {
        ...
        Assert.assertEquals(mockConnection.lastSentMessage, TestUtil.formatMessage("R|U|testRecord|1|{\"firstname\":\"Wolfram\"}+"));
    ...
    public void sendsUpdateMessageForPathChange() throws DeepstreamRecordDestroyedException {
        ...
        Assert.assertEquals(mockConnection.lastSentMessage, TestUtil.formatMessage("R|P|testRecord|2|lastname|SHempel+"));
    ...
    public void sendsPatchForNestedUpdate() {
        ...
        Assert.assertEquals(mockConnection.lastSentMessage, TestUtil.formatMessage("R|P|testRecord|1|address[0].street|SrandomStreet+"));
    ...
    public void deletesValueWhenReceivingUndefined() {
        ...
        record.onMessage(MessageParser.parseMessage(TestUtil.formatMessage("R|P|testRecord|2|firstname|U+"), deepstreamClientMock));
    ...
    public void deletesNestedObjectValueWhenReceivingUndefined() {
        ...
        record.onMessage(MessageParser.parseMessage(TestUtil.formatMessage("R|P|testRecord|3|drinks.beer|U+"), deepstreamClientMock));
    ...
    public void deletesArrayValueWhenReceivingUndefined() {
        ...
        drinks.add("coffee");
        record.set("drinks", drinks);
        record.onMessage(MessageParser.parseMessage(TestUtil.formatMessage("R|P|testRecord|3|drinks[ 0 ]|U+"), deepstreamClientMock));
    ...
    public void deletesNestedArrayValueWhenReceivingUndefined() {
        ...
        record.onMessage(MessageParser.parseMessage(TestUtil.formatMessage("R|P|testRecord|2|address[ 0 ].street|U+"), deepstreamClientMock));
